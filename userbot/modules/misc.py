...
REPOLINK = str(
    UPSTREAM_REPO_URL) if UPSTREAM_REPO_URL else "https://github.com/TEAM-TANDAV-X/LEGACY-LEAVERS-USERBOT"
# ============================================
...
async def killdabot(event):
    ...
    await event.edit("`turn off Legacy-Userbot....`")
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "╭‒─‒──────────‒─‒╮\n"
        "│                   ʀᴇᴘᴏ\n"
        "│       [⚡Legacy-Project⚡](https://github.com/TEAM-TANDAV-X/LEGACY-LEAVERS-USERBOT)\n"
        "├‒─‒──────────‒─‒╯\n"
        "│🔰 **ᴏᴡɴᴇʀ :** [Leagcy](t.me/LEGACY_LEAVERS_FORCE)\n"
        "╰‒─‒──────────‒─‒╯\n"
        "  𝗟𝗶𝗰𝗲𝗻𝘀𝗲 : [GPL-3.0 License](https://github.com/TEAM-TANDAV-X/LEGACY-LEAVERS-USERBOT/blob/Leagcy-UserBot/LICENSE)"
    )
